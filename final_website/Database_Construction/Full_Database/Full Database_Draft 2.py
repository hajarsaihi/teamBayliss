...
con = sqlite3.connect('FULL_DATABASE_DRAFT_2.db')
...
cur.execute("CREATE TABLE inhibitor_information(ChEMBL_ID PRIMARY KEY, INCHI VARCHAR(300), SMILES VARCHAR(30),TARGETS TEXT, Name VARCHAR(300),\
...
with open('raw_inhibitor_data_final.csv','rb') as fin: # reads file in Binary mode, fin is the file name which is used below 
	...
	to_in_1 = [(i['ChEMBL_ID'], i['INCHI'], i['SMILES'], i['TARGETS'], i['Name'],i['Synonyms'], i['Type'], i['Max_Phase'], i['Molecular_Weight'],\
...
cur.executemany("INSERT INTO inhibitor_information(ChEMBL_ID,INCHI,SMILES,TARGETS,Name,Synonyms,Type,Max_Phase,\
